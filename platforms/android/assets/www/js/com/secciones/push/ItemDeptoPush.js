function ItemDeptoPush($num, $label)
{
	...
	col4.className = 'Push_col4'
	$(this.main).append(col4)
	var chk_promos = new BotonToogle("img/mapa/checkbox.svg", 'promos' , 20, 40, _callback)
	$(col4).append(chk_promos.main);
	...
	this._select = function($type){
		...
		switch($type){
			...
			case "promos":   chk_promos.setSelected(true);  break;
		}
 	...
 	this.getValue =  function(){
 		...
 		return {e:chk_eventos.getSelected(), o:chk_ofertas.getSelected(), p:chk_promos.getSelected()};
